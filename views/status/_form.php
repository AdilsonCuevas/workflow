...
<div class="workflow-status-form">
    ...
    <fieldset>
        <legend><?= 'Metadata' ?>
            <?php
            // new metadata button
            echo Html::a('<span class="glyphicon glyphicon-plus"></span> ' . 'New Metadata', 'javascript:void(0);', [
    ...
    <?= Html::submitButton('<span class="glyphicon glyphicon-check"></span> ' . ($model->status->isNewRecord ? 'Create' : 'Save'), [
        'id' => 'save-' . $model->formName(),
        'class' => 'btn btn-success'
    ]) ?>
    <?= Html::a('Cancel', ['default/view', 'id' => $model->status->workflow_id], ['class' => 'btn btn-default']) ?>
